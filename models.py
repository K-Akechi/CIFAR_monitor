...
def vgg19(image, train_flag):
    with tf.variable_scope('conv1_1'):
        ...
        output = tf.nn.relu(conv2d(image, w_conv1_1, 1) + b_conv1_1)

    with tf.variable_scope('conv1_2'):
        w_conv1_2 = weight_variable([3, 3, 64, 64])
        b_conv1_2 = bias_variable([64])
        output = tf.nn.relu(conv2d(output, w_conv1_2, 1) + b_conv1_2)
    ...
    with tf.variable_scope('conv2_1'):
        ...
        output = tf.nn.relu(conv2d(output, w_conv2_1, 1) + b_conv2_1)

    with tf.variable_scope('conv2_2'):
        w_conv2_2 = weight_variable([3, 3, 128, 128])
        b_conv2_2 = bias_variable([128])
        output = tf.nn.relu(conv2d(output, w_conv2_2, 1) + b_conv2_2)
    ...
    with tf.variable_scope('conv3_1'):
        ...
        output = tf.nn.relu(conv2d(output, w_conv3_1, 1) + b_conv3_1)

    with tf.variable_scope('conv3_2'):
        w_conv3_2 = weight_variable([3, 3, 256, 256])
        b_conv3_2 = bias_variable([256])
        output = tf.nn.relu(conv2d(output, w_conv3_2, 1) + b_conv3_2)

    with tf.variable_scope('conv3_3'):
        w_conv3_3 = weight_variable([3, 3, 256, 256])
        b_conv3_3 = bias_variable([256])
        output = tf.nn.relu(conv2d(output, w_conv3_3, 1) + b_conv3_3)

    with tf.variable_scope('conv3_4'):
        w_conv3_4 = weight_variable([3, 3, 256, 256])
        b_conv3_4 = bias_variable([256])
        output = tf.nn.relu(conv2d(output, w_conv3_4, 1) + b_conv3_4)
    ...
    with tf.variable_scope('conv4_1'):
        ...
        output = tf.nn.relu(conv2d(output, w_conv4_1, 1) + b_conv4_1)

    with tf.variable_scope('conv4_2'):
        w_conv4_2 = weight_variable([3, 3, 512, 512])
        b_conv4_2 = bias_variable([512])
        output = tf.nn.relu(conv2d(output, w_conv4_2, 1) + b_conv4_2)

    with tf.variable_scope('conv4_3'):
        w_conv4_3 = weight_variable([3, 3, 512, 512])
        b_conv4_3 = bias_variable([512])
        output = tf.nn.relu(conv2d(output, w_conv4_3, 1) + b_conv4_3)

    with tf.variable_scope('conv4_4'):
        w_conv4_4 = weight_variable([3, 3, 512, 512])
        b_conv4_4 = bias_variable([512])
        output = tf.nn.relu(conv2d(output, w_conv4_4, 1) + b_conv4_4)
    ...
    with tf.variable_scope('conv5_1'):
        ...
        output = tf.nn.relu(conv2d(output, w_conv5_1, 1) + b_conv5_1)

    with tf.variable_scope('conv5_2'):
        w_conv5_2 = weight_variable([3, 3, 512, 512])
        b_conv5_2 = bias_variable([512])
        output = tf.nn.relu(conv2d(output, w_conv5_2, 1) + b_conv5_2)

    with tf.variable_scope('conv5_3'):
        w_conv5_3 = weight_variable([3, 3, 512, 512])
        b_conv5_3 = bias_variable([512])
        output = tf.nn.relu(conv2d(output, w_conv5_3, 1) + b_conv5_3)

    with tf.variable_scope('conv5_4'):
        w_conv5_4 = weight_variable([3, 3, 512, 512])
        b_conv5_4 = bias_variable([512])
        output = tf.nn.relu(conv2d(output, w_conv5_4, 1) + b_conv5_4)
    ...
    with tf.variable_scope('fc1'):
        ...
        output = tf.nn.relu(tf.matmul(output, w_fc1) + b_fc1)
    ...
    with tf.variable_scope('fc3'):
        ...
        output = tf.nn.relu(tf.matmul(output, w_fc3) + b_fc3)
